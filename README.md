...
```bash
git clone https://github.com/Irsyad-ald11/portofolio.git
cd portofolio
````
...
Hai, saya ahmad irsyad (username GitHub: `Irsyad-ald11`).
...
[1]: https://github.com/Irsyad-ald11/portofolio "GitHub - rissss21/portofolio"
